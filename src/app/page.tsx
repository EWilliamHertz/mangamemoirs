...
const PRICING = [
  {
    ...
    badge: '',
    perks: ['2-3 manga panels', '4 anime clips (5s)', 'PDF memoir upload', '5 reference slots', 'Basic styles', 'Scene editor'],
    cta: 'Get Started',
    href: '/sign-up',
  },
  {
    ...
    badge: 'Most Popular',
    perks: ['75 credits total', '25 manga panels', '37 anime clips (5s)', 'All art styles', 'Unlimited references', 'Priority queue'],
    cta: 'Get Creator',
    href: '/sign-up',
  },
  {
    ...
    badge: 'Best Value',
    perks: ['250 credits total', '83 manga panels', '125 anime clips (5s)', 'Commercial use', 'Team collaboration', 'Dedicated support'],
    cta: 'Get Studio',
    href: '/sign-up',
  },
];
